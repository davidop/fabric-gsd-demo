...
ones). Reference: @/workspaces/fabric-gsd-demo/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /workspaces/fabric-gsd-demo/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/workspaces/fabric-gsd-demo/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/workspaces/fabric-gsd-demo/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/workspaces/fabric-gsd-demo/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/spec.md.
