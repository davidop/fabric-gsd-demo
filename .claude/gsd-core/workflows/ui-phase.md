...
```markdown
Read /workspaces/fabric-gsd-demo/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspaces/fabric-gsd-demo/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspaces/fabric-gsd-demo/.claude/agents/gsd-ui-checker.md for instructions.
