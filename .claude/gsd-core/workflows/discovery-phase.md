...
See /workspaces/fabric-gsd-demo/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspaces/fabric-gsd-demo/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspaces/fabric-gsd-demo/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspaces/fabric-gsd-demo/.claude/gsd-core/templates/discovery.md
...
Use /workspaces/fabric-gsd-demo/.claude/gsd-core/templates/discovery.md.
