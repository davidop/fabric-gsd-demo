...
INSTALL_JS_GLOBAL="/workspaces/fabric-gsd-demo/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /workspaces/fabric-gsd-demo/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
