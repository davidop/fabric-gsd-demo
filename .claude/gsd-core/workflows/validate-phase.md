...
```
Agent(
  prompt="Read /workspaces/fabric-gsd-demo/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/VALIDATION.md`
