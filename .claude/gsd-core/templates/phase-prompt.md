...
<!-- For checkpoint task examples and patterns, see @/workspaces/fabric-gsd-demo/.claude/gsd-core/references/checkpoints.md -->
...
See `/workspaces/fabric-gsd-demo/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/workspaces/fabric-gsd-demo/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
