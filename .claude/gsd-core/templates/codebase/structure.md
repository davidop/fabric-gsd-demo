...
- Usage: Reference from command with `@/workspaces/fabric-gsd-demo/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /workspaces/fabric-gsd-demo/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspaces/fabric-gsd-demo/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
