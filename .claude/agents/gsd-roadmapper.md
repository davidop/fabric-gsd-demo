...
Reference full template: `/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/state.md`.
