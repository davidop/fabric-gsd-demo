...
<required_reading>
@/workspaces/fabric-gsd-demo/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/workspaces/fabric-gsd-demo/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspaces/fabric-gsd-demo/.claude
                  → checks /workspaces/fabric-gsd-demo/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspaces/fabric-gsd-demo/.claude/gsd-core
                  → writes to /workspaces/fabric-gsd-demo/.claude/gsd-core/hooks/
...
@/workspaces/fabric-gsd-demo/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/workspaces/fabric-gsd-demo/.claude/gsd-core/references/common-bug-patterns.md
