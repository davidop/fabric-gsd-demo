...
<reference>
@/workspaces/fabric-gsd-demo/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/workspaces/fabric-gsd-demo/.claude/gsd-core/references/user-profiling.md` to load:
