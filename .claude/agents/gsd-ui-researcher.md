...
Use template from `/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/workspaces/fabric-gsd-demo/.claude/gsd-core/templates/UI-SPEC.md`
