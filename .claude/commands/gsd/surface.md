...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/workspaces/fabric-gsd-demo/.claude/.gsd-surface.json`
(sibling to `/workspaces/fabric-gsd-demo/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/workspaces/fabric-gsd-demo/.claude/skills/gsd-*/`.
...
(`/workspaces/fabric-gsd-demo/.claude`), NOT the skills sub-directory (`/workspaces/fabric-gsd-demo/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/workspaces/fabric-gsd-demo/.claude` as `configDir`. The skill dirs themselves live at
`/workspaces/fabric-gsd-demo/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/workspaces/fabric-gsd-demo/.claude}"
SCOPE="global"
...
(i.e. `/workspaces/fabric-gsd-demo/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/workspaces/fabric-gsd-demo/.claude/.gsd-surface.json`
Install profile marker: `/workspaces/fabric-gsd-demo/.claude/.gsd-profile`
Skill dirs: `/workspaces/fabric-gsd-demo/.claude/skills/gsd-*/`
Engine module: `/workspaces/fabric-gsd-demo/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/workspaces/fabric-gsd-demo/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
