...
<execution_context>
@/workspaces/fabric-gsd-demo/.claude/gsd-core/workflows/manager.md
...
Read and execute `/workspaces/fabric-gsd-demo/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
